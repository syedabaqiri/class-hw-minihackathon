    ...
    <div className="bg-blue-50 min-h-screen py-8 px-4">
      ...
      <div className="text-center mb-8">
        ...
        <div className="grid grid-cols-2 gap-4 text-left max-w-2xl mx-auto text-sm">
          ...
          <p>
            <span className="font-semibold">Engine:</span> 1100 CC
          </p>
          <p>
            <span className="font-semibold">Condition:</span> 10 / 10
          </p>
          <p>
            <span className="font-semibold">Driven:</span> 0 KM
          </p>
          <p>
            <span className="font-semibold">Suspension Type:</span> Soft Suspension
          </p>
          <p>
            <span className="font-semibold">Avg:</span> 30 Km per ltr
          </p>
          <p>
      ...
      {/* Price Section */}
      <div className="text-center mb-8">
        <p className="text-green-600 text-2xl font-bold">PKR 7,00,000</p>
      </div>
