    ...
    <div className="bg-blue-50 min-h-screen py-8 px-4">
      ...
      <div className="text-center mb-8">
        ...
        <div className="grid grid-cols-2 gap-4 text-left max-w-2xl mx-auto text-sm">
          ...
          <p>
            <span className="font-semibold">Engine:</span> 1300 CC
          </p>
          <p>
            <span className="font-semibold">Condition:</span> 6.5 / 10
          </p>
          <p>
            <span className="font-semibold">Driven:</span> 51,304 KM
          </p>
          <p>
            <span className="font-semibold">Suspension Type:</span> Hard Suspension
          </p>
          <p>
            <span className="font-semibold">Avg:</span> 24 Km per ltr
          </p>
          <p>
